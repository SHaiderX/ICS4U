...
x=str(input('Pick a, d, or s, depending on if you want attack, defence, or support'))
y=input('Which number ability do you want?')
one = HeroChooseAbility(x, y) 
x1=input('Pick a, d, or s, depending on if you want attack, defence, or support')
y1=input('Which number ability do you want?')
two = HeroChooseAbility(x1, y1)
x2=input('Pick a, d, or s, depending on if you want attack, defence, or support')
y2=input('Which number ability do you want?')
